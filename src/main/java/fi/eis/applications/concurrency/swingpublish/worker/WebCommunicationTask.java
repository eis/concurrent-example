...
public class WebCommunicationTask extends
		SwingWorker<Void, DownloadProgressInfo> {
	...
	private static final String TARGET_URL = "http://cdimage.debian.org/debian-cd/7.1.0/amd64/iso-cd/debian-7.1.0-amd64-netinst.iso";

	/**
	 * Downloads a big file into memory. Doesn't actually do anything with it,
	 * instead throws the downloaded bytes away...
	 * 
	 */
	@Override
